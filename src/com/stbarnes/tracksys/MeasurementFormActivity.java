...
public class MeasurementFormActivity extends Activity {

	private static final String POST_URL = "http://tracksys-mothership.appspot.com/measurement";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.measurement_form, menu);
		return true;
	}
